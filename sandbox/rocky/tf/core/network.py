...
class MLP(LayersPowered, Serializable):
    def __init__(self, name, output_dim, hidden_sizes, hidden_nonlinearity,
                 output_nonlinearity, hidden_W_init=L.XavierUniformInitializer(), hidden_b_init=L.ZerosInitializer(),
                 output_W_init=L.XavierUniformInitializer(), output_b_init=L.ZerosInitializer(),
...
class ConvNetwork(LayersPowered, Serializable):
    def __init__(self, name, input_shape, output_dim,
                 ...
                 hidden_W_init=L.XavierUniformInitializer(), hidden_b_init=L.ZerosInitializer(),
                 output_W_init=L.XavierUniformInitializer(), output_b_init=L.ZerosInitializer(),
